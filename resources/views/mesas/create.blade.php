    ...
    <div class="row page-titles mx-0 mb-4">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4 class="text-primary fw-bold">Agregar Mesa</h4>
                <p class="mb-0 text-light">Registra una nueva mesa en el restaurante</p>
            </div>
        </div>
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-light">Agregar</li>
            </ol>
        </div>
    </div>
                ...
                <div class="card-body bg-light p-5" style="border-radius: 0 0 1rem 1rem;">
                    <form action="{{ route('mesas.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="numero" id="numero" class="form-control form-control-lg rounded-3 shadow-sm"
                                   placeholder="Ej: Mesa Principal, A1, VIP, etc." required>
                        </div>

                        <!-- Capacidad -->
                        <div class="mb-4">
                            <label for="capacidad" class="form-label fw-semibold text-dark">Capacidad de personas:</label>
                            <input type="number" name="capacidad" id="capacidad" class="form-control form-control-lg rounded-3 shadow-sm"
                                   placeholder="Ej: 4" min="1" required>
                        </div>

                        <!-- Estado -->
                        <div class="mb-4">
                            <label for="estado" class="form-label fw-semibold text-dark">Estado inicial:</label>
                            <select name="estado" id="estado" class="form-select form-select-lg rounded-3 shadow-sm bg-white" required>
