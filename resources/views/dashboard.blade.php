...
@section('content')
<div class="container-fluid py-4" style="background: linear-gradient( #111111ff, #111111ff); min-height;">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						<h2 class="text-white font-w600 mb-0">DOÑA TERNERA</h2>
						<p class="mb-0 text-white">Bienvenido al Restaurante...!</p>
					</div>
					...
					<div class="dropdown custom-dropdown">
						<div class="btn btn-sm btn-primary light d-flex align-items-center svg-btn" data-toggle="dropdown">
							...
							<div class="text-left ml-3">
								<span class="d-block fs-16">CALENDARIO</span>
								<small class="d-block fs-13">4 Noviembre 2025</small>
							</div>
						...
						<div class="widget-stat card" style="background: linear-gradient(135deg, #e2dedeff, #b1c254ff); color: white; box-shadow: 0 4px 15px rgba(239,68,68,0.3); border-radius: 1rem;">
							...
							<div class="card-body orders-summary">
								<div class="d-flex order-manage p-3 align-items-center mb-4">
									...
									<h4 class="mb-0">Nuevos Pedidos <i class="fa fa-circle text-success ml-1 fs-15"></i></h4>
								...
								<div class="row">
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											...
											<p class="fs-16 mb-0">Pedidos</p>
										</div>
									</div>
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">60</h2>
											<p class="fs-16 mb-0">Preparación</p>
										</div>
									</div>
									<div class="col-sm-4 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">7</h2>
											<p class="fs-16 mb-0">Terminado</p>
										</div>
									</div>
								</div>
									...
									<div class="row align-items-center mx-0">
										...
										<div class="col-xl-9 col-lg-8 col-xxl-8 col-sm-8 px-0">
											<div class="d-flex align-items-center mb-3">
												<p class="mb-0 fs-14 mr-2 col-4 px-0">Pedidos (24%)</p>
											...
											<div class="d-flex align-items-center  mb-3">
												<p class="mb-0 fs-14 mr-2 col-4 px-0">Preparación (41%)</p>
												<div class="progress mb-0" style="height:8px; width:100%;">
											...
											<div class="d-flex align-items-center">
												<p class="mb-0 fs-14 mr-2 col-4 px-0">Terminado (15%)</p>
												<div class="progress mb-0" style="height:8px; width:100%;">
							...
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								...
								<div class="dropdown mt-3 mt-sm-0">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="#">A Diario</a>
							...
							<div class="card-body revenue-chart px-3">
									<div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
										...
										<div class="d-flex align-items-end">
											...
											<div>
												<small class="text-dark fs-14">Gastos</small>
												<h3 class="font-w600 mb-0">$<span class="counter">41,512</span>k</h3>
											</div>
										</div>
									</div>
