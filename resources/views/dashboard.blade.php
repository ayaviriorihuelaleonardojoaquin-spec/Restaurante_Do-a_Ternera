...
<div class="container-fluid" >
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						...
						<p class="mb-0">Bienvenido al Restaurante...!</p>
					</div>
					...
					<div class="dropdown custom-dropdown">
						<div class="btn btn-sm btn-primary light d-flex align-items-center svg-btn" data-toggle="dropdown">
							...
							<div class="text-left ml-3">
								...
								<small class="d-block fs-13">2 Julio 2025 - 2 Julio 2025</small>
							</div>
							<i class="fa fa-angle-down scale5 ml-3"></i>
						</div>
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="#">2 Julio 2025 - 2 Julio 2025</a>
							<a class="dropdown-item" href="#">2 julio 2025 - 2 Julio 2025 </a>
						</div>
					</div>
				</div>
